    ...
    public function submitPost($body, $user_to, $imageName){
         ...
         if($check_empty != ""){
            ...
            $query = mysqli_query($this->con, "INSERT INTO posts VALUES(
			 ...
			 present presented presenting presents problem problems put puts hello guys q quite r
...
<?php
    ...
    public function loadProfilePosts($data, $limit){
          ...
          $str = ""; //String to return
          $data_query  = mysqli_query($this->con, "SELECT * FROM posts WHERE  deleted='no'
           AND ((added_by='$profileUser' AND user_to='none') OR user_to='$profileUser') ORDER BY id DESC");
...
<?php
   ...
   $comments_check_num = mysqli_num_rows($comments_check);
                            ...
                            $str .= "<div class ='status_post' onClick='javascript:toggle$id()'>
                                ...
                                <div class ='posted_by' style='color:#ACACAC;'>
                                <a href='$added_by'> $first_name $last_name </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; $time_massage
                                $delete_button
                                </div>
